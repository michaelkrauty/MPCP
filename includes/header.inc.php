  ...
  <div class='container'>
    ...
    <div class='navbar-collapse'>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <a href="" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span> <?php include_once "./includes/minecrafticon.inc.php"; ?><?php echo $userEmail; ?> <b class="caret"></b></a>
