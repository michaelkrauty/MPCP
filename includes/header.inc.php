<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  <div class='container'>
	...
	<?php if($pageName == "index"){echo "<li class='active'>";}else{echo "<li>";}?><a href='http://dominationvps.com/mpcp' title="Home"><span class="glyphicon glyphicon-home" style="font-size:28px;"></span></a></li>
        <?php if($pageName == "manage"){echo "<li class='active'>";}else{echo "<li>";}?><a href='http://dominationvps.com/mpcp/manage' title="Manage"><span class="glyphicon glyphicon-cog" style="font-size:28px;"></span><br></a></li>
