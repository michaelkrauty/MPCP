<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  <div class='container'>
	...
	<?php if($pageName == "index"){echo "<li class='active'>";}else{echo "<li>";}?><a href='http://dominationvps.com/mpcp'><span class="glyphicon glyphicon-home" style="font-size:28px;"></span><br></a></li>
