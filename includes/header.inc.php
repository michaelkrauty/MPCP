  ...
  <div class='container'>
	...
	<?php if($pageName == "index"){echo "<li class='active'>";}else{echo "<li>";}?><a href='http://dominationvps.com/mpcp' title="Home"><span class="glyphicon glyphicon-home" style="font-size:28px;"></span></a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <a href="" class="dropdown-toggle" data-toggle="dropdown"></span> <?php  include_once './includes/printMCIcon.inc.php'; MCIcon($userName); ?><?php echo " " . $userName; ?> <b class="caret"></b></a>
