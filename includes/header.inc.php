  ...
  <div class='container'>
	...
	<?php if($pageName == "index"){echo "<li class='active'>";}else{echo "<li>";}?><a href='http://dominationvps.com/mpcp' title="Home"><span class="glyphicon glyphicon-home" style="font-size:28px;"></span></a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <?php //<img src="http://hydra-media.cursecdn.com/minecraft.gamepedia.com/6/6a/Emerald.png" height='48' width='48'> <?php include_once 'includes/db_connect.php'; $result =  getEmeralds($userName); while($row = mysqli_fetch_array($result)) { echo $row['emeralds']; } ; ?> ?>
